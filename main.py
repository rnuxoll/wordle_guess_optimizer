...
"""
def match_in_position(character, position, initial_set, minimum_instances=1):
...
def return_possibilities(feedback, initial_set):
    ...
    for letter in feedback:
        if letter[1] == []:
            ...
            current_set = match_in_position(letter[0], letter[1], current_set)
...
def calculate_entropy_of_possibility_space(guess_space, possibility_space):
    ...
    for guess in guess_space:
        ...
        for possibility in possibility_space:
            ...
            # todo take negative log base 2 of this
            possibility_percentage = len(possibilities) / size_of_possibility_space

            # todo we get a math.domain error
            try:
...
if __name__ == '__main__':
    ...
    quit()
    possibilities = match_in_position("r", list(range(5)), minimum_instances=2)
